      ...
      <div className="min-h-screen text-foreground overflow-x-hidden" style={{ background: BG_BLACK, color: TEXT_LIGHT }}>
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-cover bg-no-repeat bg-center shadow-lg overflow-hidden nav-sticky-mobile" style={{ backgroundImage: `url(${goldFoil})`, backgroundBlendMode: 'overlay', position: 'relative' }}>
          ...
          <div className="container mx-auto px-4 py-2 flex flex-col md:flex-row items-center md:justify-between gap-2 md:gap-0 relative z-10">
            ...
            >
              <span className="relative z-2">INVEST NOW</span>
        ...
        <section id="pillars" className="py-16 w-full relative overflow-visible">
          <div className="relative z-10 max-w-7xl mx-auto w-full px-4 md:px-6">
            ...
            <div className="flex flex-col gap-8">
              ...
              {/* Provider Card */}
              <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }} className="flex flex-col md:flex-row-reverse items-stretch rounded-2xl shadow-xl border border-[#D4AF37] bg-black overflow-visible" style={{ borderRadius: 11, overflow: 'hidden' }}>
                <div className="flex-shrink-0 w-full md:w-1/3 flex items-stretch">
              ...
              {/* Lover Card */}
              <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1.2 }} className="flex flex-col md:flex-row items-stretch rounded-2xl shadow-xl border border-[#D4AF37] bg-black overflow-visible" style={{ borderRadius: 11, overflow: 'hidden' }}>
                <div className="flex-shrink-0 w-full md:w-1/3 flex items-stretch">
        ...
        {/* Pricing Section */}
        <section id="pricing" className="py-16 max-w-7xl mx-auto w-full px-4 md:px-6 flex flex-col justify-center">
          ...
          <div className="flex flex-col md:flex-row gap-8 max-w-5xl mx-auto mb-6 items-stretch justify-center" style={{ marginTop: '2.5rem' }}>
            ...
            <div className="relative flex flex-col items-center" style={{ flex: '1 1 0', minWidth: 280 }}>
              <div className="absolute -top-8 left-1/2 -translate-x-1/2 z-20" style={{ pointerEvents: 'none' }}>
            ...
            {/* Split in 2 Card */}
            <div className="flex flex-col items-center" style={{ flex: '1 1 0', minWidth: 280 }}>
