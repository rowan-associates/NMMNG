...
export default function LinkInBio() {
  return (
    <>
      <Helmet>
        <title>No More Mr. Nice Guy® – Links to Real Transformation</title>
        <meta name="description" content="All the official links for No More Mr. Nice Guy® UK: Bootcamp, Authentic Lover Blueprint, Executive Coaching, and Community. Real transformation, not surface fixes." />
        <meta property="og:title" content="No More Mr. Nice Guy® – Links to Real Transformation" />
        <meta property="og:description" content="All the official links for No More Mr. Nice Guy® UK: Bootcamp, Authentic Lover Blueprint, Executive Coaching, and Community. Real transformation, not surface fixes." />
        <meta property="og:image" content="/assets/men.webp" />
        <meta property="og:image:width" content="1536" />
        <meta property="og:image:height" content="1024" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://join.nmmng.co/" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="No More Mr. Nice Guy® – Links to Real Transformation" />
        <meta name="twitter:description" content="All the official links for No More Mr. Nice Guy® UK: Bootcamp, Authentic Lover Blueprint, Executive Coaching, and Community. Real transformation, not surface fixes." />
        <meta name="twitter:image" content="/assets/men.webp" />
        <meta property="twitter:url" content="https://join.nmmng.co/" />
      </Helmet>
      <div style={{
        minHeight: '100vh',
