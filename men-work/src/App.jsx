  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content="https://join.nmmng.co/assets/bootcamp-hero.png" />
        ...
        <meta name="twitter:image" content="https://join.nmmng.co/assets/bootcamp-hero.png" />
...
function LoverLanding() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show sticky nav only after hero is out of view
      if (loverHeroRef.current) {
        const heroRect = loverHeroRef.current.getBoundingClientRect();
        setIsScrolled(heroRect.bottom <= 0);
      } else {
        setIsScrolled(window.scrollY > 100);
      }
